...
const CoursesForm = ({formData, handleFromChange, onSubmit}) =>{
    //Variables
            ...
            <div className="d-flex flex-column flex-lg-row justify-content-around mb-lg-3">
                <div className="col-lg-3 mb-3">
                    <SelectOption
                        label={"استاد"}
                        name={'teacher_id'}
                        value={formData?.teacher_id ? formData?.teacher_id : formData?.teacher?.id}
                        options={teachers}
                ...
                <div className="col-lg-3 mb-3">
                    <SelectOption
                        label={"درس"}
                        name={'lesson_id'}
                        value={formData?.lesson_id ? formData?.lesson_id : formData?.lesson?.id}
                        options={lessons}
                        onChange={handleFromChange}
                    />
                </div>
                ...
                <div className="col-lg-3 mb-3">
                    <SelectOption
                        label={"کلاس"}
                        name={'class_id'}
                        value={formData?.class_id ? formData?.class_id : formData?.class?.id}
                        options={classes}
                        onChange={handleFromChange}
                    />
                </div>
